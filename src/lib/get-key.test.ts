...
test('should get s3 file key', () => {
  const urls = [
    {
      expect: 'fetch/img06.kaspersky.site/a61770a2722efd9b9ecad84737fbcb36.jpg',
      input:
        'https://res.cloudinary.com/dhn6iym7c/image/fetch/https://img06.kaspersky.site/a61770a2722efd9b9ecad84737fbcb36.jpg',
    },
    {
      expect: 'fetch/img06.kaspersky.site/v1574130638/e9c28405b973fc7d6929a9b7c96910b0.jpg',
      input:
